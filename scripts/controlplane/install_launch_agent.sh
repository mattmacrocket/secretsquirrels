...
LABEL="${CONTROLPANE_LAUNCHD_LABEL:-com.secretsquirrels.controlplane}"
...
<dict>
  ...
  <string>/tmp/secretsquirrels-controlplane.launchd.log</string>
  <key>StandardErrorPath</key>
  <string>/tmp/secretsquirrels-controlplane.launchd.err.log</string>
</dict>
</plist>
PLIST
