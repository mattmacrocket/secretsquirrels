...
- `/Users/matt/code/secretsquirrels` — This orchestration repository.
...
From the SecretSquirrels directory, run:
...
Before enabling the connector in Docker, confirm that the ClownPeanuts TAXII2 API is responding correctly. From the SecretSquirrels directory:
