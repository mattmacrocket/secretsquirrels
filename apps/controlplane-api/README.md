...
- `/orchestration/summary`: managed repo and workflow status from SecretSquirrels.
...
```bash
docker build -f apps/controlplane-api/Dockerfile -t secretsquirrels-controlplane-api .
```
