...
export const metadata: Metadata = {
  title: "SecretSquirrels Control Plane",
        ...
        <div className="cp-shell">
          <div className="cp-main">
            <header className="cp-topbar">
              <Link href="/overview" className="cp-topbar-brand" aria-label="SecretSquirrels home" />
            ...
            <footer className="cp-footer">
              <a
                href="https://github.com/mattmacrocket/secretsquirrels"
                target="_blank"
                rel="noreferrer"
